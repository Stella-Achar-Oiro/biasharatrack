  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="text-center">
        ...
        >
          <p className="text-2xl font-semibold text-gray-600 mt-4">{t('errors.serverError.title')}</p>
          <p className="text-gray-500 mt-2">{t('errors.serverError.message')}</p>
        </motion.div>
        <motion.div 
          className="mt-6"
          initial={{ opacity: 0, y: 50 }}
        ...
        >
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            {t('errors.serverError.buttons.tryAgain')}
          </motion.button>
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            {t('errors.serverError.buttons.dashboard')}
          </motion.button>
        </motion.div>
      </div>
    </div>
